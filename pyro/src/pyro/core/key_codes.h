...
namespace  pyro
{
    ...
    public:
        ...
        static constexpr int NUM_0         = 48;
        static constexpr int NUM_1         = 49;
        static constexpr int NUM_2         = 50;
        static constexpr int NUM_3         = 51;
        static constexpr int NUM_4         = 52;
        static constexpr int NUM_5         = 53;
        static constexpr int NUM_6         = 54;
        static constexpr int NUM_7         = 55;
        static constexpr int NUM_8         = 56;
        static constexpr int NUM_9         = 57;
        ...
        static constexpr int NUMPAD_0      = 320;
        static constexpr int NUMPAD_1      = 321;
        static constexpr int NUMPAD_2      = 322;
        static constexpr int NUMPAD_3      = 323;
        static constexpr int NUMPAD_4      = 324;
        static constexpr int NUMPAD_5      = 325;
        static constexpr int NUMPAD_6      = 326;
        static constexpr int NUMPAD_7      = 327;
        static constexpr int NUMPAD_8      = 328;
        static constexpr int NUMPAD_9      = 329;
        ...
        static constexpr int LAST_VALUE    = MENU;
    };
